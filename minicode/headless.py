...
def _write_headless_messages_trace(
    ...
    *,
    ...
    prompt: str,
    runtime: dict | None,
    result_messages: list[ChatMessage] | None,
    ...
    try:
        ...
        logging.getLogger("minicode.headless").warning(
            "Could not redact the optional headless trace payload",
            exc_info=True,
        )
...
def run_headless(prompt: str | None = None, allow_edits: bool = False) -> str:
    ...
    try:
        ...
        try:
            ...
            logger.warning("Could not dispose the head tool registry", exc_info=True)
