...
logger = logging.getLogger("minicode.task_graph")
...
class WorktreeIsolator:
    ...
    def cleanup_worktree(self, worktree_path: Path) -> None:
        ...
        try:
            ...
            logger.warning("Git worktree cleanup failed for %s", worktree_path, exc_info=True)
        ...
        if worktree_path.exists():
            ...
            try:
                ...
                logger.warning("Filesystem worktree cleanup failed for %s", worktree_path, exc_info=True)
