"""Interactive installer for MiniCode Loop.
...
def _install_launcher_script() -> tuple[str, str, str] | None:
    ...
    if sys.platform == "win32":
        ...
        launcher_script = "\r\n".join([
            "@echo off",
            "REM MiniCode Loop Launcher for Windows",
        ...
        launcher_script = "\n".join([
            "#!/usr/bin/env bash",
            "# MiniCode Loop Launcher for macOS",
        ...
        launcher_script = "\n".join([
            "#!/usr/bin/env bash",
            "# MiniCode Loop Launcher for Linux",
            "set -euo pipefail",
            f'exec "{python_exe}" -m minicode.main "$@"',
            "",
        ])
