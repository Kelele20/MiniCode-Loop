...
- Generated at: 2026-09-11T12:02:15.051100+00:00
- Status: blocked
- Local gates: blocked
...
| pytest-q | passed | 0 | 97 passed in 6.45s |
...
| structure-compliance-artifact | passed | 0 | structure compliance artifact valid: focused_gates=18 materials=3 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | --- |
| headless-smoke | provider_channel_unavailable | configuration | false | local-configuration | Repair model-to-provider channel configuration. | provider-config | - | - | 1 | 2026-09-11 20:02:22,545 [WARNING] minicode.config: Project .mcp.json found at .mcp.json but NOT loaded (security: use --trust-project-mcp or MINI_CODE_TRUST_PROJECT_MCP=1). |
...
- Provider: anthropic
- Provider ready: no
- Channel: anthropic channel not configured
- Fallback ready: no
- Risk scope: provider-config
- Summary: readiness: blocked (anthropic) [Provider is anthropic for this model, but ANTHROPIC_API_KEY/ANTHROPIC_AUTH_TOKEN is not configured.]
- Guidance:
...
| --- | --- | --- | --- |
| primary-provider-config | blocked | anthropic channel not configured | Run a live provider smoke before release. |
...
| live-smoke-readiness | not-run | Readiness preflight is local-only and does not call the model provider. | Run the explicit provider smoke with --run-live and MINICODE_LIVE_PROVIDER_SMOKE=1. |
...
| --- | --- | ---: | --- | --- |
| bundle_manifest_json | yes | 1464 | 2df16905c340 | .temp/readiness-bundle/readiness-artifact-manifest.json |
| doctor_markdown | yes | 3522 | 7df2b8790c84 | .temp/readiness-doctor.md |
| fallback_examples_json | yes | 1022 | 68a06581db27 | .temp/readiness-fallback-examples.json |
| fallback_simulations_json | yes | 909 | 4dc77e758d9b | .temp/readiness-bundle/readiness-fallback-simulations.json |
| headless_trace | yes | 8805 | 90cc9dcf59c2 | .temp/headless-provider-smoke-trace.json |
| json | yes | 6412 | 1aa69f19de38 | benchmarks/runtime_profile_eval_results.json |
| markdown | yes | 2407 | c35e2bb34bb3 | benchmarks/runtime_profile_eval_results.md |
| patch_preview_json | yes | 1771 | e0aeb1d9b159 | .temp/readiness-fallback-patch-preview.json |
| repair_plan_json | yes | 2747 | 978aafa54ff1 | .temp/readiness-repair-plan.json |
| structure_compliance | yes | 80569 | e9b6470effbf | .temp/structure-compliance.json |