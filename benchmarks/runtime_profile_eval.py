...
def main(argv: list[str] | None = None) -> None:
    ...
    # The scripted evaluation persists supervisor telemetry. Keep it inside the
    # project rather than touching the user's MiniCode state directory.
    import minicode.cybernetic_supervisor as supervisor_store

    supervisor_store.SUPERVISOR_STATE_PATH = (
        REPO_ROOT / ".temp" / "runtime-profile-home" / "cybernetic_supervisor.json"
    )
