...
- `<workspace>/Docs/Documentation/superpowers/reports/2026-06-05-minicode-lite-productization-verify.md`
- `<workspace>/benchmarks/release_readiness_results.md`
...
- runtime profiles
  - `<workspace>/minicode/runtime_profiles.py`
- recurrent turn kernel and typed stop reasons
  - `<workspace>/minicode/turn_kernel.py`
- runtime events and widening transition
  - `<workspace>/minicode/agent_loop.py`
  - `<workspace>/minicode/types.py`
- live/runtime transcript visibility
  - `<workspace>/minicode/tui/transcript.py`
  - `<workspace>/minicode/tui/renderer.py`
  - `<workspace>/minicode/tui/input_handler.py`
- session persistence, resume, and session-level runtime summaries
  - `<workspace>/minicode/session.py`
- benchmarkable runtime-profile comparison
  - `<workspace>/minicode/runtime_profile_eval.py`
  - `<workspace>/benchmarks/runtime_profile_eval_results.md`
- partial hooks and background task plumbing
  - `<workspace>/minicode/hooks.py`
  - `<workspace>/minicode/background_tasks.py`
- CLAUDE.md loading and local/project instruction support
  - `<workspace>/minicode/prompt.py`
...
- `<workspace>/minicode/session.py`
- `<workspace>/minicode/agent_loop.py`
- `<workspace>/minicode/tooling.py`
- `<workspace>/minicode/tools/`
- `<workspace>/minicode/tui/`
...
- `<workspace>/minicode/context_isolation.py`
- `<workspace>/minicode/background_tasks.py`
- `<workspace>/minicode/agent_loop.py`
- `<workspace>/minicode/hooks.py`
- `<workspace>/minicode/tui/`
...
- `<workspace>/minicode/session.py`
- `<workspace>/minicode/tui/session_flow.py`
- `<workspace>/minicode/tui/transcript.py`
- `<workspace>/minicode/tui/renderer.py`
...
- `<workspace>/minicode/prompt.py`
- `<workspace>/minicode/prompt_pipeline.py`
- `<workspace>/minicode/config.py`
- `<workspace>/minicode/tui/`
